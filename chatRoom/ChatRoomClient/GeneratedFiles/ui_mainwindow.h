...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_server->setGeometry(QRect(50, 30, 61, 20));
        label_port = new QLabel(centralWidget);
        label_port->setObjectName(QStringLiteral("label_port"));
        label_port->setGeometry(QRect(50, 120, 54, 12));
        ...
        le_server->setGeometry(QRect(120, 30, 181, 20));
        le_port = new QLineEdit(centralWidget);
        le_port->setObjectName(QStringLiteral("le_port"));
        le_port->setGeometry(QRect(120, 110, 181, 20));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_server->setText(QApplication::translate("MainWindow", "\346\234\215\345\212\241\345\231\250\345\234\260\345\235\200", Q_NULLPTR));
        label_port->setText(QApplication::translate("MainWindow", "\347\253\257\345\217\243\345\217\267", Q_NULLPTR));
